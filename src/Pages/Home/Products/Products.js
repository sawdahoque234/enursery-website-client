...
const Products = () => {
  ...
  useEffect(() => {
    fetch(`https://cryptic-fortress-77677.herokuapp.com/products?page=${page}&&size=${size}`)
      .then((res) => res.json())
      .then((data) => {
  ...
  return (
    <Container>
      <Box sx={{ flexGrow: 1 }}>
        <Typography
          variant="h6"
          sx={{ fontWeight: "400", color: "info.main", margin: 4 }}
          component="div"
        >
        ...
        <Typography
          variant="h3"
          sx={{ fontWeight: 500, m: 3, color: "#9907ed" }}
          component="div"
        ></Typography>
